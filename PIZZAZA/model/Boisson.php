...
class Boisson extends Produit{
    ...
    public function __construct(int $Id_Produit = NULL, string $nom_produit = NULL, string $type_produit = NULL, float $prix_produit = NULL, int $quantité = NULL, string $image = NULL){
      if (!is_null($Id_Produit) && $type_produit == 'Boisson'){
    ...
    public function getNom() {return $this->nom_produit;}
    public function getPrix() {return $this->prix_produit;}
  ...
  {
    $query = "INSERT INTO Produit (nom_produit, type_produit, prix_produit, quantité, image) VALUES ('" . $tab["nom_produit"] . "', 'Boisson' ," . $tab["prix_produit"] . ", " . $tab["quantité"] . ", './img/boisson.png')";
    echo $query;
